...
function Input({ className, ...props }: React.ComponentProps<typeof TextInput> & React.RefAttributes<TextInput>) {
  ...
  return (
    <TextInput
      className={cn(
        multiline
          ? 'dark:bg-input/30 border-input bg-background text-foreground w-full min-w-0 self-stretch rounded-md border px-3 py-3 text-base leading-6 shadow-sm shadow-black/5 sm:text-sm'
